...
const HaveMaterialBrandMatch: React.FC = () => {
  return (
      ...
      <div className="flex flex-col gap-8 px-[87px] max-md:px-5">
        ...
        <div className="w-full max-w-[1029px] h-[542px] flex justify-center items-center relative max-md:h-auto">
          <div className="w-[824px] h-[480px] border-2 border-black bg-white relative max-md:w-full max-md:h-auto max-md:p-[40px_20px]">
            ...
            {/* Select button */}
            <Link to="/have-material/ikea-collaboration" className="absolute right-0 top-0 w-[174px] h-[62px] bg-black flex items-center px-[19px] max-md:static max-md:w-full max-md:mt-5">
        ...
        <div className="w-full max-w-[1029px] h-[542px] flex justify-center items-center relative max-md:h-auto">
          <div className="w-[824px] h-[480px] border-2 border-black bg-white relative max-md:w-full max-md:h-auto max-md:p-[40px_20px]">
            ...
            {/* Select button */}
            <Link to="/have-material/lego-collaboration" className="absolute right-0 top-0 w-[174px] h-[62px] bg-black flex items-center px-[19px] max-md:static max-md:w-full max-md:mt-5">
              <div className="font-['Poppins',sans-serif] text-[31px] text-white">
                Select
              </div>
              <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-auto">
        ...
        <div className="w-full max-w-[1029px] h-[542px] flex justify-center items-center relative max-md:h-auto">
          <div className="w-[824px] h-[480px] border-2 border-black bg-white relative max-md:w-full max-md:h-auto max-md:p-[40px_20px]">
            ...
            {/* Select button */}
            <Link to="/have-material/decathlon-collaboration" className="absolute right-0 top-0 w-[174px] h-[62px] bg-black flex items-center px-[19px] max-md:static max-md:w-full max-md:mt-5">
              <div className="font-['Poppins',sans-serif] text-[31px] text-white">
                Select
              </div>
              <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-auto">
...
export default HaveMaterialBrandMatch;
